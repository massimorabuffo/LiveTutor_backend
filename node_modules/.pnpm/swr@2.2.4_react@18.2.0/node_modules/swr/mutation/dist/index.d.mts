...
interface SWRMutationHook {
     ...
     */
    options?: SWRMutationConfiguration<Data, Error, SWRMutationKey, ExtraArg, SWRData>): SWRMutationResponse<Data, Error, SWRMutationKey, ExtraArg>;
    <Data = any, Error = any, SWRMutationKey extends Key = Key, ExtraArg = never, SWRData = Data>(
    /**
     * The key of the resource that will be mutated. It should be the same key
     * used in the `useSWR` hook so SWR can handle revalidation and race
...
export { MutationFetcher, SWRMutationConfiguration, SWRMutationHook, SWRMutationResponse, TriggerWithArgs, TriggerWithOptionsArgs, TriggerWithoutArgs, useSWRMutation as default };
